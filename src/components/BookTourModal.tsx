...
function BookTourModal({ isOpen, onClose }: BookTourModalProps) {
  ...
  return (
    <>
      ...
      <div 
        className="fixed inset-0 z-50 flex items-start md:items-center justify-center p-2 sm:p-4 pt-2 pb-4 sm:pt-24 sm:pb-4 md:pt-6 lg:pt-8 pointer-events-none" 
        onClick={onClose}
