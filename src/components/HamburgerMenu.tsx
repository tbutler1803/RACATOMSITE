  ...
  return (
    <>
      ...
      >
        ...
        {/* Filler spacer to push contact section to bottom */}
        <div className="relative z-10 flex-1" />

        {/* Contact/footer block */}
        <div
          className="relative z-10 px-6 pt-6 pb-6 border-t border-[var(--color-gold-accent)]/20 space-y-2 text-[var(--color-cream)]/85 text-sm tracking-[0.18em]"
        >
